...
echo CHtml::dropDownList('xnameid', 0, array(0=>'请选择')+ (array)CHtml::listData((array)$this->areas, 'id', 'name'),array('class'=>"ft12 selwidth"));
?>		
<script>
$(function(){
	$('#cnameid').live('change',function(){
		var url = '<?php  echo url("{$this->controller->id}/area");?>';
