<div class="ma">
  ...
  <div class="hp_top">
   ...
   <div class="hp_t1"><a href="<?php echo url("user/oaskusercomment/lscomment")?>"><font color="#ffffff">好评（<?php echo $pages->itemCount?>）</font></a></div>
   <div class="hp_t2"><a href="<?php echo url("user/oaskusercomment/lscommentchaping")?>"><font color="#000000">差评（<?php echo $numchaping;?>）</font></a></div>
  </div>
  <div class="hp_text">
     <?php
