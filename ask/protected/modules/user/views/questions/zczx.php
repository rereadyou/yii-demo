...
<div class="ma_lsb">
<div class="ma_gk_tob">
 <div class="zti_a"><span class="ma_zt">个人资料管理</span> >>专长咨询 </div>
  ...
  <div class="lb_ds_a">
    <ul>
      ...
      foreach($questions as $k=>$v){
        ?>
        <li style="width:390px; text-align:left; padding-left:18px;">·<a   href='<?php echo AskTool::Qustion_GetUrl($v->ID)?>' target=_blank ><?php echo AskTool::str_cut($v->title, 33) ?></a></li>
