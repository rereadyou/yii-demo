...
<div class="ma_lsb_tob">
	<div class="zti_a"><span class="ma_zt">个人资料管理</span> >>  律师已回复咨询</div>
	<div class="bolck10"></div>
    <div class="ld_sc">
    <ul>
      <li style="width:540px; text-align:center;">标题</li>
      <li style="width:140px;">接收人</li>
      <li>咨询时间</li>
    </ul>
  </div>
</div>
  ...
  <div class="lb_ds_a">
    <ul>
        ...
        ?>
      <li style="width:412px; text-align:left; padding-left:18px;">·<a href='<?php echo url('user/message/view',array('id'=>$v->ID,'class'=>'yhf'))?>'><?php echo $v->Title  ?></a></li>
	   <li style="width:110px; height:35px">

           </li>
      <li style="width:130px;"><?php   echo empty($v->oaskreply->TrueName)?$v->oaskreply->name:$v->oaskreply->TrueName; ?></li>
