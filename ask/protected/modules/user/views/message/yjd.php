...
<div class="ma_lsb_tob">
	<div class="zti_a"><span class="ma_zt">个人资料管理</span> >>  我已解答的咨询</div>
  ...
  <div class="lb_ds_a">
    <ul>
        ...
        foreach($questions as $k=>$v)
            {
        ?>
      <li style="width:412px; text-align:left; padding-left:18px;">·<a href='<?php echo  url('user/message/view',array('id'=>$v->ID,'class'=>'yjd'))?>'><?php echo $v->Title  ?></a></li>
	   <li style="width:110px; height:35px"><a href='<?php echo url('user/message/view',array('id'=>$v->ID,'class'=>'yjd'))?>'><img  src="/images/user/zg_d.gif" width="46" height="26" /></a></li>
