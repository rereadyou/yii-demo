 ...
 <div class="xg_main">
  <div class="fs">
    <table width="730" border="0" cellpadding="0" cellspacing="1" bgcolor="#E4E4E4">
      <tr>
        <td height="30" colspan="3" bgcolor="#effaff">&nbsp;<span class="cu">上传证书</span></td>
        </tr>
      
       <tr>
          <td height="30" align="right" bgcolor="#effaff"><span class="cu_1">证书名称：</span>&nbsp; </td>
        <td align="center" bgcolor="#FFFFFF"><img src="/images/xgzl_r2_c2.jpg" width="13" height="7" /></td>
        <td bgcolor="#FFFFFF"><div class="contact">
          	<?php echo $form->textField($model,'CertName',array('class'=>'kk')); ?>
        </div></td>
      </tr>
      
       <tr>
          <td height="30" align="right" bgcolor="#effaff"><span class="cu_1">上传证书：</span>&nbsp; </td>
        <td align="center" bgcolor="#FFFFFF"><img src="/images/xgzl_r2_c2.jpg" width="13" height="7" /></td>
        <td bgcolor="#FFFFFF"><div class="contact">
          	<?php echo $form->fileField($model,'Certpic'); ?>
        </div></td>
      </tr>
      
      <tr>
        <td height="30" align="right" bgcolor="#effaff"><span class="cu_1">证书介绍：</span>&nbsp;</td>
        <td align="center" bgcolor="#FFFFFF"><img src="/images/xgzl_r2_c2.jpg" width="13" height="7" /></td>
        <td bgcolor="#FFFFFF"><div class="contact">
         
		<?php $this->widget('application.extensions.fckeditor.FCKEditorWidget',array(
			"model"=>$model,				# Data-Model
			"attribute"=>'CertMemo',			# Attribute in the Data-Model
			"height"=>'200px',
			"width"=>'100%',
