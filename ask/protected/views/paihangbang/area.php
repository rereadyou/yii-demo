...
<div class="man">
    ...
    <div class="zmsn">
        <div class="btn_tj"><img src="/css/paihangbang/images/jfen.gif" width="196" height="42" /></div>
        ...
        <div class="manz_yo">
            ...
            <div class="zyu">
                ...
                <div class="zyu_a">
                    <div class="dsh">
                        <div class="shuj"><?php echo $areaname . $zhuanchangname;?> </div>
                        <div class="diq"></div>
                    ...
                    <div class="dshd">
                        <div class="dshd">
                            <div class="dshd_cds">
                                ...
                                <div class="bolck10"></div>
                                <div class="dshtp">
                                    <div class="bjtup_a" id="tab11"  onmouseover="showitem(1)">回复数量排行榜</div>
                                    <div class="bjdsd_a"  id="tab12" onmouseover="showitem(2)">采纳数量排行榜</div>
                                    <div class="bjdsd_a"  id="tab13" onmouseover="showitem(3)">好评数量排行榜</div>
                                </div>
                                <div class="hxed_s"></div>
                                <div class="bolck10"></div>

                                <div class="bolck10"></div>
                                <div style="text-align:left; line-height:25px; font-size:13px; font-weight:bold; padding-left:5px; ">
                                    <div class="dxint">
                                        <ul>
                                            <li style=" width:50px; color:#fff;">dd</li>
                                            <li class="q6"> 姓 名</li>
                                            <li style="width:80px; text-align:center;">地 区</li>
                                            <li  style=" width:143px; text-align:center;">积分</li>
                                            <li style=" width:80px; text-align:center;">联系方式<li>
                                            <li style=" width:120px; text-align:center;">专 长<li></ul>
                                    </div>
                                </div>

                                <div class=" ph_c" id="jifenlist1" style="display: none1" >
                                    <ul>
                                        <?php
                                        // print_r($viplist);
                                        if ($replylist) {
                                            foreach($replylist as $k=>$v) {
                                                ?> <li><div class="q12"><?php echo $k+1;?></div>
                                            <div class="q6"><a href='<?php echo $v['url']; ?>'><?php echo $v['truename']; ?>律师</a></div>
                                            <div class="q7"><?php echo $v['pname']; ?>-<?php echo $v['cname']; ?></div>
                                            <div class="q6"><?php echo $v['jifen']; ?></div>
                                            <div class="q8"><?php echo $v['mobile']; ?>&nbsp;</div>
                                            <div class="q8"><?php echo $v['spec']; ?></div>
                                            <div class="q6"><a href='<?php echo $v['askme']; ?>'><img src="/css/paihangbang/images/pahd.gif" width="53" height="18" /></a></div>
                                        </li>
                                                <?php
                                            }
                                        }
                                ...
                                <div class=" ph_c" id="jifenlist2"  style="display: none">
                                    <ul>
                                        <?php
                                        if($bestlist) {
                                ...
                                <div class=" ph_c" id="jifenlist3" style="display: none">
                                    <ul>
                                        <?php
                                        if($hplist) {
                                            foreach($hplist as $k=>$v) {
                                                ?> <li><div class="q12"><?php echo $k+1;?></div>
                                            <div class="q6"> <a href='<?php echo $v['url']; ?>'><?php echo $v['truename']; ?></a> </div>
                                            <div class="q7"><?php echo $v['pname']; ?>-<?php echo $v['cname']; ?>&nbsp;</div>
                                            <div class="q6"><?php echo $v['jifen']; ?></div>
                                            <div class="q8"><?php echo $v['mobile']; ?>&nbsp;</div>
                                            <div class="q8"><?php echo $v['spec']; ?>&nbsp;</div>
    ...
    <script language="javascript">
        function hiddenall_jifen()
        {
            for( i=1;i<=3;i++)
            {
                document.getElementById('jifenlist'+i).style.display='none';
                document.getElementById('tab1'+i).className='bjdsd_a';
            }

        }
        function showitem(id)
        {   hiddenall_jifen();
            document.getElementById('jifenlist'+id).style.display='';
            document.getElementById('tab1'+id).className='bjtup_a';
