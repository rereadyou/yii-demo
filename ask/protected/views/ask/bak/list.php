...
foreach ($questions as $k=>$v) {
	...
	CHtml::link( AskTool::str_cut($v->title, 36),url('ask/detail',array('id'=>$v->ID)))."</td><td align='center'>".
	$v->views."</td><td align='center'><img src='images/p.jpg' width='10' height='9' />".
...
<?php
$tiao="<input type='input' size=5 name='gopage' style='float:left;'  class='gopage'/><input type='button' value='转到' class='gopage'/>";
$this->widget('CLinkPager', array(
    ...
    'nextPageLabel' => '下页',
    'prevPageLabel' => '上页',
     'footer'=>$tiao .'&nbsp;&nbsp;总数'.$pages->ItemCount . ',每页' .$pages->pageSize . ',页次 <font color=red>' . $pages->currentpage . '</font>/' .$pages-> pageCount ,
     'maxButtonCount'=>4,
));
